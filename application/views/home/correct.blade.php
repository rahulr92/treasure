...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>BrainStrain 13 | Drishti </title>
...
<div id="fb-root"></div>
     <script type="text/javascript">
       var button;
            ...
            var po_checker =0;
            var messager ="Brainstarin 13"
            <?php if(Auth::user()->level==1){ ?>
            
            messager = "Be warned, this person may undergo a meltdown any time, he has taken the ultimate triage and started playing brainstrain";
            
            <?php }else{ ?>
            
             messager = "Crossed Level "+{{Auth::user()->level-1}}+" In BrainStrain 13" ;
            
            <?php } ?>
            
            window.fbAsyncInit = function() {
                FB.init({ appId: '504607669591353', //change the appId to your appId
                    status: true, 
                    cookie: true,
                    xfbml: true,
                    oauth: true});
            ...
            function graphStreamPublish(){
                ...
                FB.api('/me/feed', 'post', 
                    { 
                        ...
                        picture     : 'https://fbcdn-profile-a.akamaihd.net/hprofile-ak-ash4/c66.66.828.828/s160x160/1000110_685328484814764_856915636_n.jpg',
                        name        : 'BrainStrain 13',
                        description : 'You know the deal. Do not waste your trains of thought reading this. Log in and rack your brains for some constructive facedesking.'
...
<ol>
<li>
   BrainStrain'13 is an online crypt hunt which shall be held over <b>9</b> days from <b>11:59:59 on 28th       
       August'13 to 
 23:59:59 on 5th September'13</b> (IST).
</li><li>
      The hunt will be of <b>45</b> levels.
</li><li>
      Anyone having an active <b>facebook </b> account can be a participant.
</li><li>
