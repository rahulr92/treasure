      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
          <li class="active">
		<a class="back_h" href="http://cetdrishti.com/">Drishti 13</a>
	 </li> 
   <li class="">
    <a class="back_h" href="/credits">Credits</a>
   </li> 
    ...
    <div class="c6 holer s3" style="background:black;">

        <a href="http://cetdrishti.com/"><img src="img/finish.png"><h2><center>Yeah !!! I'm On Fire !</center></h2></a>
