...
class Home_Controller extends Base_Controller {
	...
	public function action_auth()
	{
		...
		$provider = OAuth2::provider($provider, array(
			'id' => '504607669591353',
			'secret' => '752045071c7b3d32491afc965102de50',
			));
	...
	private function action_fbfeeder($type = 0){
		...
		if ($type == 0) {
			$fb_message = "Be warned, this person may undergo a meltdown any time, he has taken the ultimate triage and started playing brainstrain";
		}else{
			$fb_message = "Crossed  ".$type." Level in brain strain 13!!";
		}
